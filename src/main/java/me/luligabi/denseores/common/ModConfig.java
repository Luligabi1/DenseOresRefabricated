...
public class ModConfig implements Config { // TODO: Half values to be less OP, add values for the un-genned ores.
    ...
    public int redstoneChunkOdds = 4;
    ...
    public int emeraldChunkOdds = 100;
    ...
    public int ancientDebrisVeinSize = 2;
